...
<div class="container-fluid">
    <div id="login_box" style="margin-top: 3em">
        <div class="row">
            <img src="images/Logo_Rough.png" alt="soundscape"
                 style="margin-left: 6em; margin-top: 2.5em; margin-bottom: 0.5em"/>
        </div>
        <div class="row">
            ...
            <br>
            <input type="password" placeholder="Password" id="login_field">
            <br>
